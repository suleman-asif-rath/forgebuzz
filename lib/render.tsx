...
// The C-Tile logo, inlined as an SVG data URI so Satori can rasterise it.
const LOGO_SVG =
  ...
  `<path d="M84.4 30.9 A38 38 0 1 0 84.4 89.1" fill="none" stroke="#0B1020" stroke-width="15" stroke-linecap="round"/>` +
  `</svg>`;
